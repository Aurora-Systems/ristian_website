    ...
    return (
        <div>
            <div className="bg-black d-flex justify-content-between p-2 text-white  align-items-center">
                ...
                <div>
                    <a href="tel:+263777839595"><button className="btn text-white primary_button">Call Us</button></a>
                </div>
            </div>
            <div className="d-flex  justify-content-center align-items-center" style={{ ...bg_img("https://ngratesc.sirv.com/ristian/home.jpg"), height: "90vh" }}>
                <div className="text-center bg-light bg-opacity-50 p-5 rounded">
                    ...
                    <a href="https://wa.me/263777839595"><button className="btn primary_button">Find Out More</button></a>
                </div>
            </div>
            <div className="container-fluid">
                <div className="row">
                    <div className="col-sm  primary_background text-white p-5">
                        ...
                        <a href="https://wa.me/263777839595"><button className="btn secondary_button">Get In Touch</button></a>
                    </div>
                ...
                <div className="row">
                    <div className="col-sm bg-black order-md-2 text-white p-5 align-items-center d-flex">
                        <div>
                            ...
                            <a href="https://wa.me/263777839595"><button className="btn primary_button">Get In Touch</button></a>
                        </div>

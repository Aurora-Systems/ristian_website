        ...
        <div>
            ...
            <div className="d-flex  justify-content-center align-items-center"
                ...
                <div className="text-center bg-light bg-opacity-50 p-5 rounded">
                    ...
                    <p className="f fst-italic">"Connecting Talent with Top Employers in the UK,Poland,Canada, Bulgaria,
                        Lithuania, and Australia"</p>
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-sm  primary_background text-white p-5">
                        ...
                        <p>At Ristian Consultancy, we specialize in connecting talented professionals with leading
                            companies across the UK, Poland, Canada, Bulgaria, Lithuania, and Australia. With over 100
                            partner companies, we offer a wide range of job placements tailored to fit your skills,
                            educational background, and career aspirations.</p>
                        <a href="https://wa.me/263771939493" target="_blank">
                            <button className="btn secondary_button">Get In Touch</button>
                        </a>
                    </div>
                    <div className="col-sm  p-5"
                         style={{...bg_img("https://ngratesc.sirv.com/ristian/home_second.jpg"), minHeight: "50vh"}}>
                ...
                <div className=" pb-4">
                    ...
                    <div className="row gap-3 m-4 text-center">
                        <div className="col-sm bg-black p-3 rounded">
                            ...
                            <p>Your CV and cover letter are often your first impression with potential employers. Our
                                professional writing service ensures that your application materials stand out. We
                                tailor each CV and cover letter to highlight your strengths, skills, and experiences,
                                presenting you as the ideal candidate for the job. With our expert touch, you’ll
                                confidently present your qualifications and make a lasting impression.</p>
                        </div>
                        <div className="col-sm bg-black p-3 rounded">
                            <p className="fw-bold">Training and Coaching</p>
                            <p>Success in your career requires more than just securing a job; it involves continuous
                                learning and development. Our training and coaching services are designed to enhance
                                your skills and prepare you for the demands of your new role. Whether you need
                                industry-specific training, interview coaching, or guidance on career development, our
                                experts provide personalized support to help you thrive in your career.</p>
                        </div>
                        <div className="col-sm bg-black p-3 rounded">
                            <p className="fw-bold">Employment Procurement</p>
                            <p>We specialize in matching talented individuals with top companies across the UK, Poland,
                                Canada, Bulgaria, Lithuania, and Australia. Our recruitment service is personalized to
                                ensure that we find the right fit for both the candidate and the employer. We work with
                                over 100 companies in various industries, offering opportunities in healthcare, IT,
                                education, hospitality, construction, and more. Whatever your field, we have the
                                connections and expertise to help you find your next role.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="row gap-4 m-4">
                    <div className="col-sm bg-white rounded d-flex  justify-content-center mb-2">
                        <div>
                            ...
                            <p className="fst-italic">Ristian Consultancy made my dream of working abroad a reality.
                                Their team was incredibly supportive throughout the entire process, and I landed a
                                fantastic job in the UK. Highly recommend their services!"</p>
                    ...
                    <div className="col-sm bg-white rounded mb-2">
                        ...
                        <Star/>
                        <br/>
                        <p className="fst-italic">"I was looking for a job in Australia, and Ristian Consultancy
                            connected me with a great employer. The team was professional and responsive. They truly
                            care about finding the right fit for you."</p>
                    ...
                    <div className="col-sm bg-white rounded mb-2">
                        ...
                        <Star/>
                        <br/>
                        <p className="fst-italic">"I secured a nursing position in Canada. The process was smooth, and
                            they guided me every step of the way. I couldn&apos;t be happier with my new role! Can't
                            recommend enough"</p>
            ...
            <div className="text-center container pt-2 pb-2">
                ...
                <p>
                    Whether you're looking to advance your career or explore new opportunities abroad, Ristian
                    Consultancy is here to help you achieve your goals. Explore our job listings, submit your CV, and
                    let us connect you with the right employers.
                    <br/>
